...
# python train_translation.py --epochs 20 --dataset multi30k --seed 13 --save_every 2000 --uniform --config configs/model.json
...
# python train_translation.py --epochs 30 --dataset iwslt14 --seed 13 --save_every 2000 --uniform --config configs/model.json
...
# python train_translation.py --epochs 30 --dataset news_commentary_v14_cs_fr --seed 13 --save_every 2000 --uniform --config configs/model.json
