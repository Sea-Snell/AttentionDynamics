...
Download our processed data folder [here](https://drive.google.com/drive/folders/1erdWgIK8wxypwgOZScy8uB7yDWFRzVoU?usp=sharing). Make sure this folder is named ```data``` and place it in the ```classification/``` directory
...
Download our processed data folder [here](https://drive.google.com/drive/folders/1b_Oyxci1EpOK-LJc4u0IJ-lmtWsu9dK3?usp=sharing). Make sure this folder is named ```data``` and place it in the ```translation/``` directory
